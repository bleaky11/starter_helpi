    ...
    <Router>
          ...
          <HeaderComponent setPage={setPage} page={page} />
            <Routes>
              ...
              <Route path="/" element={<MainPage setPage={setPage} count = {count} page={page} basicComplete={basicComplete} detailedComplete={detailedComplete} isKeyEntered={isKeyEntered}/>}/>
            </Routes>
          </>
